...
int main(int argc, char *argv[]) {
    ...
    if (auth_token.size() != 64 ||
        auth_token.find_first_not_of("0123456789abcdef") != std::string::npos) {
        perrorf("fatal: missing or invalid Prime authentication token.\n");
        exit(EXIT_FATAL_TOKEN);
    }
